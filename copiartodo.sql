...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `EJERCICIO3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `COCHES` (
  ...
  `NUM_PUERTAS` int(11) DEFAULT 5,
  `TFNO` int(11) DEFAULT NULL,
  PRIMARY KEY (`MATRICULA`),
  KEY `FK1` (`TFNO`),
  CONSTRAINT `FK1` FOREIGN KEY (`TFNO`) REFERENCES `USUARIOS` (`TFNO`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `REVISIONES` (
  ...
  `CODIGO_COCHE` varchar(10) NOT NULL,
  PRIMARY KEY (`CODIGO`),
  KEY `CODIGO_COCHE` (`CODIGO_COCHE`),
  CONSTRAINT `REVISIONES_ibfk_1` FOREIGN KEY (`CODIGO_COCHE`) REFERENCES `COCHES` (`MATRICULA`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `USUARIOS` (
  ...
  `PROVINCIA` varchar(10) DEFAULT 'MURCIA',
...
--
-- Current Database: `Practica4`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `Practica4` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
INSERT INTO `Clientes` VALUES (1,'Luis','Garcia','Madrid'),(2,'Antonio','Lopez','Valencia'),(3,'Juan','Martin','Madrid'),(4,'Maria','Garcia','Madrid'),(5,'Javier','Gonzalez','Barcelona'),(6,'Ana','Lopez','Barcelona');
...
CREATE TABLE `Distribucion` (
  ...
  CONSTRAINT `Distribucion_ibfk_1` FOREIGN KEY (`cifc`) REFERENCES `Concesionarios` (`cifc`),
  CONSTRAINT `Distribucion_ibfk_2` FOREIGN KEY (`codcoche`) REFERENCES `Coches` (`codcoche`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Marco` (
  ...
  KEY `codcoche` (`codcoche`),
  CONSTRAINT `Marco_ibfk_1` FOREIGN KEY (`cifm`) REFERENCES `Marcas` (`cifm`),
  CONSTRAINT `Marco_ibfk_2` FOREIGN KEY (`codcoche`) REFERENCES `Coches` (`codcoche`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Ventas` (
  ...
  PRIMARY KEY (`cifc`,`dni`),
  KEY `dni` (`dni`),
  KEY `codcoche` (`codcoche`),
  CONSTRAINT `Ventas_ibfk_1` FOREIGN KEY (`cifc`) REFERENCES `Concesionarios` (`cifc`),
  CONSTRAINT `Ventas_ibfk_2` FOREIGN KEY (`dni`) REFERENCES `Clientes` (`dni`),
  CONSTRAINT `Ventas_ibfk_3` FOREIGN KEY (`codcoche`) REFERENCES `Coches` (`codcoche`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Current Database: `ejercicio2`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ejercicio2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `ARTICULOS` (
  ...
  KEY `FK1` (`COD_FABRICANTE`),
  CONSTRAINT `FK1` FOREIGN KEY (`COD_FABRICANTE`) REFERENCES `FABRICANTES` (`COD_FABRICANTE`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `familia` (
  `codigofamilia` int(11) NOT NULL AUTO_INCREMENT,
  `descripcionfamilia` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `personas_familia`
--

DROP TABLE IF EXISTS `personas_familia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `personas_familia` (
  `codigofamilia` int(11) NOT NULL,
  `dni` varchar(9) NOT NULL,
  PRIMARY KEY (`codigofamilia`,`dni`),
  KEY `dni` (`dni`),
  CONSTRAINT `personas_familia_ibfk_1` FOREIGN KEY (`codigofamilia`) REFERENCES `familia` (`codigofamilia`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `personas_familia_ibfk_2` FOREIGN KEY (`dni`) REFERENCES `PACIENTE` (`dni`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personas_familia`
--

LOCK TABLES `personas_familia` WRITE;
/*!40000 ALTER TABLE `personas_familia` DISABLE KEYS */;
/*!40000 ALTER TABLE `personas_familia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `personas_vehiculos`
--

DROP TABLE IF EXISTS `personas_vehiculos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `personas_vehiculos` (
  ...
  KEY `codigovehiculo` (`codigovehiculo`),
  CONSTRAINT `personas_vehiculos_ibfk_1` FOREIGN KEY (`dni`) REFERENCES `PACIENTE` (`dni`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `personas_vehiculos_ibfk_2` FOREIGN KEY (`codigovehiculo`) REFERENCES `vehiculos` (`codigovehiculo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personas_vehiculos`
--

LOCK TABLES `personas_vehiculos` WRITE;
/*!40000 ALTER TABLE `personas_vehiculos` DISABLE KEYS */;
/*!40000 ALTER TABLE `personas_vehiculos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Current Database: `empleados`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `empleados` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
INSERT INTO `empleados` VALUES (1,'Ana',1200,NULL),(2,'Luis',1800,NULL),(3,'Marta',2600,NULL),(4,'Pedro',2500,NULL),(5,'Sofía',900,NULL);
...
CREATE TABLE `empleados2` (
  ...
  `calificacion_rendimiento` char(1) DEFAULT NULL,
...
INSERT INTO `empleados2` VALUES (1,'A',NULL),(2,'B',NULL),(3,'C',NULL),(4,'B',NULL);
...
INSERT INTO `empleados3` VALUES (1,'Abraham',30,3000);
...
INSERT INTO `db` VALUES ('%','test','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y','N'),('%','test\\_%','','Y','Y','Y','Y','Y','Y','N','Y','Y','Y','Y','Y','Y','Y','Y','N','N','Y','Y','N'),('localhost','phpmyadmin','pma','Y','Y','Y','Y','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N','N');
...
INSERT INTO `global_priv` VALUES ('localhost','root','{\"access\":1073741823,\"ssl_type\":0,\"ssl_cipher\":\"\",\"x509_issuer\":\"\",\"x509_subject\":\"\",\"max_questions\":0,\"max_updates\":0,\"max_connections\":0,\"max_user_connections\":0,\"max_statement_time\":0.000000,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1745342208,\"password_lifetime\":-1,\"account_locked\":false,\"default_role\":\"\",\"is_role\":false}'),('127.0.0.1','root','{\"access\":1073741823,\"ssl_type\":0,\"ssl_cipher\":\"\",\"x509_issuer\":\"\",\"x509_subject\":\"\",\"max_questions\":0,\"max_updates\":0,\"max_connections\":0,\"max_user_connections\":0,\"max_statement_time\":0.000000,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1745342208,\"password_lifetime\":-1,\"account_locked\":false,\"default_role\":\"\",\"is_role\":false}'),('::1','root','{\"access\":1073741823,\"ssl_type\":0,\"ssl_cipher\":\"\",\"x509_issuer\":\"\",\"x509_subject\":\"\",\"max_questions\":0,\"max_updates\":0,\"max_connections\":0,\"max_user_connections\":0,\"max_statement_time\":0.000000,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1745342208,\"password_lifetime\":-1,\"account_locked\":false,\"default_role\":\"\",\"is_role\":false}'),('localhost','','{\"access\":0,\"ssl_type\":0,\"ssl_cipher\":\"\",\"x509_issuer\":\"\",\"x509_subject\":\"\",\"max_questions\":0,\"max_updates\":0,\"max_connections\":0,\"max_user_connections\":0,\"max_statement_time\":0.000000,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1745342208,\"password_lifetime\":-1,\"account_locked\":false,\"default_role\":\"\",\"is_role\":false}'),('localhost','pma','{\"access\":0,\"ssl_type\":0,\"ssl_cipher\":\"\",\"x509_issuer\":\"\",\"x509_subject\":\"\",\"max_questions\":0,\"max_updates\":0,\"max_connections\":0,\"max_user_connections\":0,\"max_statement_time\":0.000000,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"password_last_changed\":1745342208,\"password_lifetime\":-1,\"account_locked\":false,\"default_role\":\"\",\"is_role\":false}'),('localhost','mariadb.sys','{\"access\":0,\"plugin\":\"mysql_native_password\",\"authentication_string\":\"\",\"account_locked\":true,\"password_last_changed\":0}');
...
INSERT INTO `proc` VALUES ('test','AddGeometryColumn','PROCEDURE','AddGeometryColumn','SQL','CONTAINS_SQL','NO','DEFINER','catalog varchar(64), t_schema varchar(64),\n   t_name varchar(64), geometry_column varchar(64), t_srid int','','begin\n  set @qwe= concat(\'ALTER TABLE \', t_schema, \'.\', t_name, \' ADD \', geometry_column,\' GEOMETRY REF_SYSTEM_ID=\', t_srid); PREPARE ls from @qwe; execute ls; deallocate prepare ls; end','@','2015-11-24 22:42:53','2015-11-24 22:42:53','','','latin1','latin1_swedish_ci','latin1_swedish_ci','begin\n  set @qwe= concat(\'ALTER TABLE \', t_schema, \'.\', t_name, \' ADD \', geometry_column,\' GEOMETRY REF_SYSTEM_ID=\', t_srid); PREPARE ls from @qwe; execute ls; deallocate prepare ls; end','NONE'),('test','DropGeometryColumn','PROCEDURE','DropGeometryColumn','SQL','CONTAINS_SQL','NO','DEFINER','catalog varchar(64), t_schema varchar(64),\n   t_name varchar(64), geometry_column varchar(64)','','begin\n  set @qwe= concat(\'ALTER TABLE \', t_schema, \'.\', t_name, \' DROP \', geometry_column); PREPARE ls from @qwe; execute ls; deallocate prepare ls; end','@','2015-11-24 22:42:53','2015-11-24 22:42:53','','','latin1','latin1_swedish_ci','latin1_swedish_ci','begin\n  set @qwe= concat(\'ALTER TABLE \', t_schema, \'.\', t_name, \' DROP \', geometry_column); PREPARE ls from @qwe; execute ls; deallocate prepare ls; end','NONE'),('empleados','insertar','PROCEDURE','insertar','SQL','CONTAINS_SQL','NO','DEFINER','nom varchar(255), eda int, sal int, minimo int','','BEGIN\n	IF sal > minimo\n		then\n			INSERT INTO empleados3 (nombre,edad,salario) VALUES (nom,eda,sal);\n	ELSE\n		SELECT \'El salario es demasiado bajo\';\n	END IF;\nEND','root@localhost','2025-04-22 20:56:20','2025-04-22 20:56:20','STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION','','utf8mb4','utf8mb4_general_ci','utf8mb4_general_ci','BEGIN\n	IF sal > minimo\n		then\n			INSERT INTO empleados3 (nombre,edad,salario) VALUES (nom,eda,sal);\n	ELSE\n		SELECT \'El salario es demasiado bajo\';\n	END IF;\nEND','NONE');
...
INSERT INTO `proxies_priv` VALUES ('localhost','root','','',1,'','2015-11-24 22:42:49');
...
CREATE TABLE `PRODUCTOS` (
  ...
  CONSTRAINT `PRODUCTOS_ibfk_1` FOREIGN KEY (`codigo_fabricante`) REFERENCES `FABRICANTES` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `PRODUCTOS` WRITE;
/*!40000 ALTER TABLE `PRODUCTOS` DISABLE KEYS */;
INSERT INTO `PRODUCTOS` VALUES (1,'Disco duro SATA3 1TB',86.99,5),(2,'Memoria RAM DDR4 8GB',120.00,6),(3,'Disco SSD 1TB',150.99,4),(4,'GeForce GTX 1050Ti',185.00,7),(5,'GeForce GTX 1080 Xtreme',755.00,6),(6,'Monitor 24 LED Full HD',202.00,1),(7,'Monitor 27 LED Full HD',245.99,1),(8,'Portatil Yoga 520',559.00,2),(9,'Portatil Ideapd 320',444.00,2),(10,'Impresora HP Deskjet 3720',59.99,3),(11,'Impresora HP Laserjet Pro M26nw',180.00,3);
/*!40000 ALTER TABLE `PRODUCTOS` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Current Database: `practicaA`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `practicaA` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
INSERT INTO `depart` VALUES (10,'CONTABILIDAD','SEVILLA'),(20,'INVESTIGACION','MADRID'),(30,'VENTAS','BARCELONA'),(40,'PRODUCCION','BILBAO'),(70,'Recursos Humanos','SEVILLA');
...
INSERT INTO `emple` VALUES (7369,'SANCHEZ','EMPLEADO',7902,'1990-12-17',1040,NULL,20),(7499,'ARROYO','VENDEDOR',7698,'1990-02-20',1500,390,30),(7521,'SALA','VENDEDOR',7698,'1991-02-22',1625,650,30),(7566,'JIMENEZ','DIRECTOR',7839,'1991-04-02',2900,NULL,20),(7654,'MARTIN','VENDEDOR',7698,'1991-09-29',1600,1020,30),(7698,'NEGRO','DIRECTOR',7839,'1991-05-01',3005,NULL,30),(7782,'CEREZO','DIRECTOR',7839,'1991-06-09',2885,NULL,10),(7788,'GIL','ANALISTA',7566,'1991-11-09',3000,NULL,20),(7839,'REY','PRESIDENTE',NULL,'1991-11-17',4100,NULL,10),(7844,'TOVAR','VENDEDOR',7698,'1991-09-08',1350,0,30),(7876,'ALONSO','EMPLEADO',7788,'1991-09-23',1430,NULL,20),(7900,'JIMENO','EMPLEADO',7698,'1991-12-03',1335,NULL,30),(7902,'FERNANDEZ','ANALISTA',7566,'1991-12-03',3000,NULL,20),(7934,'MUÑOZ','EMPLEADO',7782,'1992-01-23',1690,NULL,10),(8001,'CEREZO','DIRECTOR',7839,'1991-06-09',2885,NULL,30),(8002,'LOPEZ','VENDEDOR',7955,'2023-11-21',1500,400,30);
/*!40000 ALTER TABLE `emple` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `emple20`
--

DROP TABLE IF EXISTS `emple20`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `emple20` (
  ...
  PRIMARY KEY (`emp_no`),
  KEY `dept_no` (`dept_no`),
  CONSTRAINT `emple20_ibfk_1` FOREIGN KEY (`dept_no`) REFERENCES `depart` (`dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emple20`
--

LOCK TABLES `emple20` WRITE;
/*!40000 ALTER TABLE `emple20` DISABLE KEYS */;
/*!40000 ALTER TABLE `emple20` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `emple30`
--

DROP TABLE IF EXISTS `emple30`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `emple30` (
  ...
  PRIMARY KEY (`emp_no`),
  KEY `dept_no` (`dept_no`),
  CONSTRAINT `emple30_ibfk_1` FOREIGN KEY (`dept_no`) REFERENCES `depart` (`dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emple30`
--

LOCK TABLES `emple30` WRITE;
/*!40000 ALTER TABLE `emple30` DISABLE KEYS */;
/*!40000 ALTER TABLE `emple30` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Current Database: `transaccion1`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `transaccion1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
LOCK TABLES `productos` WRITE;
/*!40000 ALTER TABLE `productos` DISABLE KEYS */;
INSERT INTO `productos` VALUES (1,'Papel',10),(2,'Carne',60),(3,'Zumo',50),(4,'Refresco',50),(5,'Botella de Agua',100),(6,'Pistacho',200);
/*!40000 ALTER TABLE `productos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cliente` VALUES (1,'Aaron','Rivero','Gomez','Almeria',100),(2,'Adela','Salas','Diaz','Granada',200),(3,'Adolfo','Rubio','Flores','Sevilla',NULL),(4,'Adrian','Suarez',NULL,'Jaen',300),(5,'Marcos','Loyola','Mendez','Almeria',200),(6,'Maria','Santana','Moreno','Cadiz',100),(7,'Pilar','Ruiz',NULL,'Sevilla',300),(8,'Pepe','Ruiz','Santana','Huelva',200),(9,'Guillermo','Lopez','Gomez','Granada',225),(10,'Daniel','Santana','Loyola','Sevilla',125);
...
--
-- Current Database: `videoclub`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `videoclub` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `clientes` (
  ...
  `poblacion` varchar(20) DEFAULT 'Madrid',
...
CREATE TABLE `compras` (
  ...
  `dni_cliente` int(11) NOT NULL,
  `fecha_compra` date DEFAULT NULL,
  PRIMARY KEY (`codigo_pelicula`,`dni_cliente`),
  KEY `dni_cliente` (`dni_cliente`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`codigo_pelicula`) REFERENCES `peliculas` (`cod_pelicula`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`dni_cliente`) REFERENCES `clientes` (`dni_cliente`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `peliculas` (
  ...
  `nombre` varchar(20) DEFAULT NULL,
  `fecha_alta` date DEFAULT '2006-01-01',
...
-- Dump completed on 2025-05-13 20:47:04
